...
本系列为《MChat 产品使用手册》接口子文档，汇总**全部 MQTT 消息交互接口**的 Topic、Payload 约定及示例，便于开发对接与联调。与《产品需求方案（PRD）v1.2》接口设计一致。
...
- 本系列与《产品需求方案（PRD）v1.2》接口设计一致；action 名称、Topic、Payload 字段以 PRD 与实际实现为准。
